          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-border pb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-2 bg-secondary hover:bg-secondary/80 border border-border text-secondary-foreground text-xs font-bold rounded-xl transition-colors flex items-center gap-1.5"
              >
