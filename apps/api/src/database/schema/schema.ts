...
export const transacciones = pgTable('transacciones', {
  ...
  comisionEmpleado: decimal('comision_empleado', { precision: 10, scale: 2 }).notNull(),
  propinaEmpleado: decimal('propina_empleado', { precision: 10, scale: 2 }).notNull().default('0'),
